...
let ComplaintsController = class ComplaintsController {
    ...
    create(CreateComplaintServicesDto) {
    ...
    update(id, UpdateComplaintServicesDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ComplaintsController.prototype, "findType", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_dto_1.UpdateComplaintServicesDto]),
    __metadata("design:returntype", void 0)
...
exports.ComplaintsController = ComplaintsController = __decorate([
    ...
    __metadata("design:paramtypes", [complaint_service_1.ComplaintsService])
